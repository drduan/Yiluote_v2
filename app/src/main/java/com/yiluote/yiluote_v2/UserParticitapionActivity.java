...
public class UserParticitapionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		group_list.add("我发过的评论");
		group_list.add("我点过的赞");
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				Toast.makeText(
						UserParticitapionActivity.this,
						"group="
								+ groupPosition
								+ "---child="
								+ childPosition
								+ "---"
								+ item_list.get(groupPosition).get(
	...
	class MyExpandableListViewAdapter extends BaseExpandableListAdapter {
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(context).inflate(
						R.layout.item_user_participation_father, null);
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(context).inflate(
						R.layout.item_user_participation_child, null);
